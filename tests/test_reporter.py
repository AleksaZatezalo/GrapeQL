...
class TestReporter:
    ...
    def test_findings_categorization(self, reporter):
        ...
        categorized = reporter._categorize_findings() if hasattr(reporter, '_categorize_findings') else None
        if categorized:
    ...
    def test_report_statistics(self, reporter, sample_findings):
        ...
        stats = reporter._calculate_statistics() if hasattr(reporter, '_calculate_statistics') else None
        if stats:
